...
namespace Armoury
{
    public class Settings
    {
        ...
        public int StarvationWoundPercent = 5;            // a STARVING party in the field loses this share of its regulars to wounds per day (vanilla 25 - a whole army wounded in four days; 0 = off, 25 = vanilla). Player and AI alike
        ...
        public float ForageHearthPerDay = 0.8f;            // hearths a 500-man army drains per day (scales with army size)
        public int ForageFloor = 25;                       // marching armies can never drain a village below this - true ruin takes a real raid
        public int ScarThresholdHearth = 150;              // below this many hearths a village counts as scarred and heals slowly
        public int ScarRegenPercent = 25;                  // share of normal hearth growth a scarred village keeps (vanilla springs back at +4/day)
        ...
        public float ArmorOutlierTolerance = 1.30f;        // Armour Sense Law: pieces above norm x this get trimmed down to it
        ...
        // --- House levies ---
        public bool HouseLeviesEnabled = true;             // in settlements owned by a house with its own troop line (Blackwood, Tully, Karstark, Lannister...) the NOBLE volunteers the game already offers are that house's men of the same tier - same rule and frequency as noble recruits anywhere, no extra dice
