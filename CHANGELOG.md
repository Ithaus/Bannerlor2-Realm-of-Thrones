...
**Status:** WGRANE 2026-09-16 (Armoury.dll md5 46e326f1191d59698e490e5b1347e297 po dolozeniu sufitu kucia z wpisu nizej, repo i gra zgodne; poprzedni DLL obok jako `Armoury.dll.bak-2026-09-16-v1-unikaty`). DO SPRAWDZENIA po wczytaniu: linia `UniqueLaw: przebranie magazynow AI po pierwszym wczytaniu`.
...
**Status:** WGRANE 2026-09-16 (Armoury.dll md5 46e326f1191d59698e490e5b1347e297, repo i gra zgodne - wgrany ponownie po dodaniu sufitu; `Armoury.json` WeaponDaysPerTier 0.5 -> 0.1, kopia `Armoury.json.bak-2026-09-16-kucie`, JSON sprawdzony). DO SPRAWDZENIA: po wczytaniu linia `Kuznia: 4 zlecen broni w kolejce skrocono...` i czas w kuzni.
